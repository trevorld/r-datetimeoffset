...
#'   datetime_offset(2020, 5, 15, 8, 23, 16, -7)
#'   datetime_offset(2020, 5, 15, 8, 23, 16, -7, 30)
...
datetime_offset <- function(year, month = NA_integer_, day = NA_integer_,
    ...
    # recycle
    rc <- vec_recycle_common(year, month, day, hour, minute, second, hour_offset, minute_offset, tz)
    year <- rc[[1]]
    month <- rc[[2]]
    day <- rc[[3]]
    hour <- rc[[4]]
    ...
    new_datetime_offset(year, month, day, hour, minute, second, hour_offset, minute_offset, tz)
}
